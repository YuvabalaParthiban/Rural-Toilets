...
<div class="container">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" id="disabledInput" name="length" type="number" placeholder="168" disabled>
      </div>
    </div>
    <div class="form-group">
        <label for="disabledInput" class="col-sm-2 control-label">Width</label>
        <div class="col-sm-10">
          <input class="form-control" id="disabledInput" name="width" type="number" placeholder="70" disabled>
        </div>
      </div>
      <div class="form-group">
        <label for="disabledInput" class="col-sm-2 control-label">Height</label>
        <div class="col-sm-10">
          <input class="form-control" id="disabledInput" name="height" type="number" placeholder="200" disabled>
        </div>
    </div>
        <div class="form-group">
            <label for="disabledInput" class="col-sm-2 control-label">Type</label>
            <div class="col-sm-10">
              <input class="form-control" id="disabledInput" name="type" type="text" placeholder="Western" disabled>
            </div>
        </div>
            <div class="form-group">
                <label for="disabledInput" class="col-sm-2 control-label">Color</label>
                <div class="col-sm-10">
                  <input class="form-control" id="disabledInput" name="color" type="text" placeholder="Grey" disabled><br>
                </div>
            </div>
            <div class="container">
...
{
  $uid1 = $_POST['uid'];
$sql3 = "INSERT INTO option1 (uid,length,width,height,type,color) VALUES ('$uid1',168,70,200,'Western','Grey') ";
