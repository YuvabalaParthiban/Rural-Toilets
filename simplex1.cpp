...
class Simplex{
    ...
    public:
        ...
        void doPivotting(int pivotRow, int pivotColumn){
            ...
            minimum =  minimum -  (C[pivotColumn]*(B[pivotRow]/pivetValue)) ;  //set the minimum step by step
        ...
        void CalculateSimplex(){
           ...
           cout<<""<<endl;
           cout<<"minimum value: " << minimum<< endl;  //print the minimum values
...
int main()
{
    ...
    int colSizeA=3;  //should initialise columns size in A
    int rowSizeA = 3;  //should initialise columns row in A[][] vector

    float C[]= {-30,-20,0};  //should initialis the c arry here
    float B[]={15000,26000,23000};  // should initialis the b array here



    float a[3][3] = {    //should intialis the A[][] array here
                   { 18900,  13200,  10900},
                   { 19400,  25000,  15980},
                   { 23450,  17800,  21030}
             };
