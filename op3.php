...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="disabledInput" name="width" type="number" placeholder="85" disabled>
        </div>
      </div>
      <div class="form-group">
        <label for="disabledInput" class="col-sm-2 control-label">Height</label>
        <div class="col-sm-10">
          <input class="form-control" id="disabledInput" name="height" type="number" placeholder="174" disabled>
        </div>
    </div>
        <div class="form-group">
...
{
  $uid1 = $_POST['uid'];
$sql3 = "INSERT INTO option3 (uid,length,width,height,type,color) VALUES ('$uid1',168,70,200,'Western','Grey') ";
