...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="disabledInput" name="width" type="number" placeholder="60" disabled>
        </div>
      </div>
      <div class="form-group">
...
{
  $uid1 = $_POST['uid'];
$sql3 = "INSERT INTO option2 (uid,length,width,height,type,color) VALUES ('$uid1',168,70,200,'Indian','White') ";
